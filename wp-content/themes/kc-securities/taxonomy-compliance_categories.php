...
<section class="sub-banner-section download-banner m-0" style="background-image:url(<?php echo site_url(); ?>/wp-content/uploads/2023/08/compliance-banner.jpg)">
    <div class="container">
	...
	<div class="container">
		...
		<div class="row g-3">
            <?php $term = get_queried_object();
                ...
                {  
                    $compliance_link = get_field('compliance_document_link', $post->ID);
                    
                    if(isset($compliance_link) && !empty($compliance_link)){
                        $file_url = $compliance_link['url'];
                       $file_extension = pathinfo($file_url, PATHINFO_EXTENSION);
                        ...
                        <a href="<?php if(isset($compliance_link) && !empty($compliance_link)){echo $compliance_link['url'];}else{echo "#";}?>" class="download-box" target = "_blank">
                            <?php 
                ...
                if(isset($children->term_id)):
                    ...
                    foreach($products as $value){
                        $download_link = get_field('compliance_document_link',$value->ID);
