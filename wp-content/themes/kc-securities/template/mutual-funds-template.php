        ...
        <div class="accordion custom-accordion wow fadeInUp" id="accordionmutual">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionmutual">
                    <div class="accordion-body">
                       <div class="mutual-part">
                        ...
                        <div class="mutual-part custom-table table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Equity invest in Stock</td>
                                        <td>Mutual fund scheme that invests predominantly in equity stocks. In the Indian context, as per current SEBI Mutual Fund Regulations, an equity mutual fund scheme must invest at least 65% of the scheme's assets in equities and equity related instruments.</td>
                                    </tr>
                                    <tr>
                                        <td>Debt Fund invest in income</td>
                                        <td>A debt fund is a mutual fund scheme that invests in fixed income instruments, such as Corporate and Government Bonds, corporate debt securities, and money market instruments etc.</td>
                                    </tr>
                                    <tr>
                                        <td>Money Market fund invest in</td>
                                        <td>A money market fund is a type of mutual fund that has relatively low risks compared to other mutual funds and most other investments and historically has had lower returns. Money market funds invest in high quality, short-term debt securities and pay dividends that generally reflect short-term interest rates.</td>
                                    </tr>
                                    <tr>
                                        <td>Balanced Fund invest in (partly in stocks and partly in fixed income sec.)</td>
                                        <td>Balanced funds, also known as hybrid funds, are a class of mutual funds that contain a bond (debt) component and a stock (equity) component in a specific ratio in a single portfolio. These mutual funds help investors diversify their portfolio by investing in asset classes such as equity and debt.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="mutual-part">
                            <p><strong>Managed by an Asset Management Company (AMC)</strong></p>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionmutual">
                    <div class="accordion-body">
                        <div class="mutual-part">
                            <p><strong>1. Net Asset Value or NAV:</strong></p>
                        ...
                        <div class="mutual-part">
                            <p><strong>2. How is NAV calculated ?</strong></p>
                        ...
                        <div class="mutual-part">
                            <p><strong>Open- and Close-Ended Funds:</strong></p>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionmutual">
                    <div class="accordion-body">
                        <div class="mutual-part">
                            <p><strong>Professional Money Management:</strong></p>
                        ...
                        <div class="mutual-part">
                            <p><strong>Flexibility and variety:</strong></p>
                        ...
                        <div class="mutual-part">
                            <p><strong>Tax benefits on Investment in Mutual Funds :</strong></p>
                            <p>a) 100% Income Tax exemption on all Mutual Fund dividends</p>
                            <p>b) Equity Funds - Short term capital gains is taxed at 15%. Long term capital gains is not applicable.Debt Funds - Short term capital gains is taxed as per the slab rates applicable to you. Long term capital gains tax to be lower of - 10% on the capital gains without factoring i ndexation benefit and 20% on the capital gains after factoring indexation benefit.</p>
                            <p>c) Open-end funds with equity exposure of more than 65% (Revised from 50% to 65% in Budget 2006) are exempt from the payment of dividend tax for a period of 3 years from 1999-2000.</p>
