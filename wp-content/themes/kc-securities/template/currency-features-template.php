...
/**
 * Template Name: Currency Features Page template
 */
        ...
        <div class="row g-4 wow fadeInUp">
            <div class="col-lg-6">
                <div class="services-content custom-point">
                    ...
                    <p><strong>Trading in currency derivatives through us has various benefits:</strong></p>
                    <ul>
                        <li>Hedge Avenues.</li>
                    ...
                    <p>Through us you can use the BSE-CD trading platform just by a simple account opening and documentation process.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="services-images equities-part">
                   <img src="<?php echo site_url(); ?>/wp-content/uploads/2023/09/currency-features.jpg" alt="Call">
                </div>
            </div>
        </div>
    </div>
